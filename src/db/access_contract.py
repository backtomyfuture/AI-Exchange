...
# Daily digest delivery is operationally independent from the ingestion
# pipeline.  It extends the physical head without changing its authority or
# polling routines.
DAILY_DIGEST_DATABASE_REVISION: Final = "20260805_0008"
...
# Revision 0008 adds a durable execution record for the daily text digest.  It
# is deliberately not a pipeline-command receipt: the runtime may read its
# own reports and mutate only the bounded execution/delivery columns below.
PHASE2_RELATIONS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    *PHASE2_RELATIONS_BY_REVISION[POLLING_ONLY_DATABASE_REVISION],
    "daily_digest_executions",
)
PHASE2_VIEW_SPECS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    PHASE2_VIEW_SPECS_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
PHASE2_DEFAULT_EXPRESSIONS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = {
...
PHASE2_GENERATED_EXPRESSION_SHA256_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    PHASE2_GENERATED_EXPRESSION_SHA256_BY_REVISION[
        SYNC_RECONCILIATION_DATABASE_REVISION
    ]
)
PHASE2_CHECK_CONSTRAINT_SHA256_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    PHASE2_CHECK_CONSTRAINT_SHA256_BY_REVISION[
        SYNC_RECONCILIATION_DATABASE_REVISION
    ]
)
PHASE2_UNIQUE_CONSTRAINTS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
...
PHASE2_INDEX_SPECS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    PHASE2_INDEX_SPECS_BY_REVISION[SYNC_RECONCILIATION_DATABASE_REVISION]
)
RUNTIME_RELATION_ACCESS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = {
    **RUNTIME_RELATION_ACCESS_BY_REVISION[POLLING_ONLY_DATABASE_REVISION],
    "daily_digest_executions": RelationAccess(
        table_privileges=("SELECT",),
        insert_columns=(
            "account_id",
            "delivery_scope_hash",
...
MAINTENANCE_RELATION_ACCESS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    MAINTENANCE_RELATION_ACCESS_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
AUDITOR_RELATION_ACCESS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    AUDITOR_RELATION_ACCESS_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
RUNTIME_ROUTINE_EXECUTE_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    RUNTIME_ROUTINE_EXECUTE_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
MAINTENANCE_ROUTINE_EXECUTE_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    MAINTENANCE_ROUTINE_EXECUTE_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
AUDITOR_ROUTINE_EXECUTE_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    AUDITOR_ROUTINE_EXECUTE_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
SECURITY_DEFINER_ROUTINES_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    SECURITY_DEFINER_ROUTINES_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
FOREIGN_KEY_SPECS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    FOREIGN_KEY_SPECS_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
TRIGGER_SPECS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    TRIGGER_SPECS_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
TRIGGER_FUNCTION_SOURCE_SHA256_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    TRIGGER_FUNCTION_SOURCE_SHA256_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
TRIGGER_FUNCTION_SEARCH_PATH_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    TRIGGER_FUNCTION_SEARCH_PATH_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
TRIGGER_FUNCTIONS_BY_REVISION[DAILY_DIGEST_DATABASE_REVISION] = (
    TRIGGER_FUNCTIONS_BY_REVISION[POLLING_ONLY_DATABASE_REVISION]
)
