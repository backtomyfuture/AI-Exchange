...
RUNTIME_RELATION_ACCESS: Final = {
    ...
    "intake_decisions": _access(table=("SELECT",), insert=("inbox_id", "execution_epoch", "external_email_id", "decision_json", "decision_digest", "disposition", "reason_code", "policy_version", "snapshot_digest")),
    "intake_releases": _access(table=("SELECT",), insert=("id", "inbox_id", "prior_execution_epoch", "new_execution_epoch", "actor", "reason")),
...
MAINTENANCE_RELATION_ACCESS: Final = {
    ...
    "intake_decisions": _access(table=("SELECT",)),
    "intake_releases": _access(table=("SELECT",)),
...
FOREIGN_KEY_SPECS: Final = (
    ...
    ForeignKeySpec(
        "fk_approved_envelope_payload",
        "approved_execution_envelopes",
        ("inbox_id", "payload_revision"),
        "execution_payload_revisions",
        ("inbox_id", "revision"),
        "s",
        update_action="a",
...
TRIGGER_SPECS: Final = (
    ...
    TriggerSpec("trg_intake_releases_guard_truncate", "intake_releases", "reject_durable_artifact_mutation", 34),
    TriggerSpec("trg_payload_revisions_guard_row", "execution_payload_revisions", "reject_durable_artifact_mutation", 27),
    TriggerSpec("trg_payload_revisions_guard_truncate", "execution_payload_revisions", "reject_durable_artifact_mutation", 34),
    TriggerSpec("trg_approved_envelopes_guard_row", "approved_execution_envelopes", "reject_durable_artifact_mutation", 27),
    TriggerSpec("trg_approved_envelopes_guard_truncate", "approved_execution_envelopes", "reject_durable_artifact_mutation", 34),
)
...
TRIGGER_FUNCTION_SOURCE_SHA256: Final = {
    ...
    "reject_durable_artifact_mutation": "5c14eff0de7a2f62974f65b5821f317c1e22f00da8fc26c51366485aa228cd95",
...
TRIGGER_FUNCTION_SEARCH_PATH: Final = {
    ...
    "reject_durable_artifact_mutation": "target_schema",
