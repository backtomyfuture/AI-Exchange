...
def run_import(
    ...
    *,
    ...
    if processor is not None and parsed_emails:
        inferred = infer_historical_route_decisions(parsed_emails)
        for email_id, decision in inferred.items():
        ...
        logger.info("Inferred historical route labels: count=%d", len(inferred))
